...
set :application, 'trotttrotttrott'
set :repository,  'git@github.com:trotttrotttrott/trotttrotttrott.git'
set :use_sudo, false
...
task :production do
  ...
  set :deploy_to, '/home/rails/trotttrotttrott'
  set :branch, 'production'
  role :web, '184.72.225.39'
  role :app, '184.72.225.39'
  role :db,  '184.72.225.39', :primary => true
end
